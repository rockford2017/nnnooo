...
# ==================== CONFIGURATION ====================
API_ID = int(os.getenv("API_ID", "1234567"))  # API ID خود را جایگزین کنید
API_HASH = os.getenv("API_HASH", "YOUR_API_HASH")  # API HASH خود را جایگزین کنید
...
STATE = {
    ...
    "sec_pv": False,
    "dice_active": False,
    "dice_target": None,  # 'even', 'odd', or 1-6
    "slot_active": False,
    "slot_target": 64,    # Default jackpot/target
    "loops": {},          # task_id: task
...
async def mention_tracker(client, message: Message):
    # ساخت لینک مستقیم و قابل کلیک به پیام
    ...
    # ارسال گزارش تگ به Saved Messages با لینک کلیک شدنی
