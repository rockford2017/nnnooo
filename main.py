...
# اتصال با پروکسی برای دور زدن بلاک آی‌پی گیت‌هاب توسط تلگرام
app = Client(
    "my_selfbot",
    api_id=API_ID,
    api_hash=API_HASH,
...
# ==================== MAIN RUNNER ====================
async def main():
    print("🔄 Starting Pyrogram Client with Proxy...")
    await app.start()
    me = await app.get_me()
    ...
    print("🚀 Selfbot is ONLINE & Receiving Updates!")
