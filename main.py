...
async def save_remote_config():
    try:
        ...
        # پاکسازی کانفیگ قبلی برای شلوغ نشدن Saved Messages
...
async def main():
    ...
    # دریافت کانفیگ از Saved Messages
    await load_remote_config()
    
    try:
        await app.send_message("me", "✅ **سلف‌بات روشن شد و تنظیمات با موفقیت سینک گردید!**")
    except Exception as e:
