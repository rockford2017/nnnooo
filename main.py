...
# تنظیمات کلاینت برای جلوگیری از قطعی و ابطال سشن
app = Client(
    "my_selfbot",
    api_id=API_ID,
    api_hash=API_HASH,
    session_string=SESSION_STRING,
    in_memory=True  # ذخیره نساختن فایل دیتابیس محلی روی دیسک اکشن گیت‌هاب
)
